...
// These tests are adapted from https://github.com/apple/swift-corelibs-foundation/blob/main/Tests/Foundation/Tests/TestUserDefaults.swift which have the following license:
...
//        defaults.set(NSURL(fileURLWithPath: "/hello/world") as URL, forKey: "key1")
//
//        XCTAssertEqual(defaults.url(forKey: "key1"), URL(fileURLWithPath: "/hello/world"))
//    }
