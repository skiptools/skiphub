...
open class NSError : CustomStringConvertible {
    ...
    open var userInfo: [String : Any] {
        ...
        #if SKIP
        fatalError("unreachabe") // SKIP TODO: shoud not be required
        #endif
    }
...
public protocol CustomNSError : Error {
    ...
    //static var errorDomain: String { get } // SKIP FIXME: Kotlin does not support static members in protocols
...
public struct POSIXError {
    ...
    //public typealias Code = POSIXErrorCode // SKIP FIXME: Kotlin does not support typealias declarations within functions and types. Consider moving this to a top level declaration
